...
module.exports = {
  ...
  run: async(client, msg, args) => {
    ...
    if(!reason) {
		...
		.setDescription('<:no:768994814527143986> **Please put the reason.**')
		.setColor(c.color);
   ...
   /* .setThumbnail(msg.author.displayAvatarURL())
    ...
    .addField('📊 STATUS :', 'OFFLINE/DOWN')
    .addField('📜 REASON :', reason)
    .addField('🎥 MENTION :', '@everyone')
    .setThumbnail('https://media.discordapp.net/attachments/620532799606095882/769149055850381332/SERVER_DOWN.gif?width=427&height=427')
